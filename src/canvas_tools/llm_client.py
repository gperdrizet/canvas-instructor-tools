...
class LLMClient:
    ...
    def _generate_anthropic(self, prompt: str, model: str, system_prompt: Optional[str] = None) -> str:
    ...
    def _generate_ollama(self, prompt: str, model: str, system_prompt: Optional[str] = None) -> str:
        messages = []
        if system_prompt:
